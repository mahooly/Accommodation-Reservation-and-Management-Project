...
class TestRegistrationForm(TestCase):
    ...
    def test_registration_form(self):
        invalid_data = {
            ...
            "last_name": "behnamnia", "email": "arminbehnamniagmail.com", "gender": "male",
        ...
        invalid_data = {
            "username": "armin_gm", "password1": "1234", "password2": "1234", "first_name": "armin",
        ...
        valid_data = {
            "username": "armin_gm", "password1": "armin12345678", "password2": "armin12345678", "first_name": "armin",
            "last_name": "behnamnia", "email": "arminbehnamnia@gmail.com", "gender": "male",
            "birth_date": datetime.date(year=1995, month=11, day=7), "is_host": True, "image": self.img
        }
    ...
    def test_change_form(self):
        invalid_data = {"email": "arminbehnamniagmail.com", "gender": "male", "image": self.img
                        }
        form = CustomUserChangeForm(data=invalid_data)
        form.is_valid()
        self.assertTrue(form.errors)
        valid_data = {"email": "arminbehnamnia@gmail.com", "gender": "male", "image": self.img
                      }
